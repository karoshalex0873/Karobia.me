            ...
            <div className="relative">
              ...
              <div className="flex flex-wrap justify-center gap-5 md:gap-8">
                {Skill.map((data, index) => (
                  <div
                    key={index}
                    className="transform transition duration-500 hover:scale-105 relative text-white  bg-gradient-to-r from-darkBrand to-secondary rounded-xl shadow-md p-4 flex flex-col items-center justify-center "
